...
<head>
  ...
  <title>Universidad Mariano</title>
...
if(isset($_GET["url"])){
  ...
  || $url[0] == "Carreras" || $url[0] == "Editar-Carrera" || $url[0] == "usuarios"
  || $url[0] == "Estudiantes" || $url[0] == "Editar-inicio" || $url[0] == "Crear-Materias"
  || $url[0] == "Crear-Comisiones" || $url[0] == "Ver-Plan" || $url[0] == "Nota-Materia"
  || $url[0] == "Editar-Nota" || $url[0] == "Plan-de-Estudios" || $url[0] == "Cursos"
  || $url[0] == "insc-materia"|| $url[0] == "inscripto-M" || $url[0] == "Examenes" || $url[0] == "Crear-Examenes" || $url[0] == "C-E"
  || $url[0] == "Ver-Examenes" || $url[0] == "insc-examen" || $url[0] == "Inscriptos-examen" || $url[0] == "Constancia-Alumno" || $url[0] == "Constancia-Cursos"
  || $url[0] == "Certificados"){
...
<script src="http://localhost/universidad/Vistas/js/cursos.js"></script>
<script>
