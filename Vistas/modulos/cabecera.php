<header class="main-header">
    ...
    <a href="http://localhost/universidad/inicio" class="logo">
      ...
      <span class="logo-mini"><img src="http://localhost/universidad/Vistas/img/icono.png" class="img-responsive"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="http://localhost/universidad/Vistas/img/logo.png" class="img-responsive"></span>
    </a>
            ...
            <ul class="dropdown-menu" style="border: 1px solid black">
              ...
              <?php
                if($_SESSION["rol"]=="Administrador"){
                  ...
                  '.$_SESSION["apellido"]." ".$_SESSION["nombre"].' - carnet: '.$_SESSION["carnet"].'
