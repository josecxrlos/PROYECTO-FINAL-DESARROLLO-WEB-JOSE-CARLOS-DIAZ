...
class CursosM extends ConexionBD{
    ...
    static public function CrearCursoM($tablaBD, $datosC){
    ...
    static public function VerCursosM($tablaBD){
    ...
    static public function VerCursos2M($tablaBD, $columna, $valor){
    ...
    //eliminar cursos
    static public function EliminarCursoM($tablaBD, $id){
    ...
    static public function CrearComisionM($tablaBD, $datosC){
        $pdo = ConexionBD::cBD()->prepare("INSERT INTO $tablaBD (id_curso, c_maxima, numero, dias, horario)
        VALUES (:id_curso, :c_maxima, :numero, :dias, :horario)");
    ...
    static public function ColocarNotaM($tablaBD, $datosC){
        ...
        $pdo = ConexionBD::cBD()->prepare("INSERT INTO $tablaBD (id_alumno, carnet, id_curso, fecha, profesor, nota_final, estado)
        VALUES (:id_alumno, :carnet, :id_curso, :fecha, :profesor, :nota_final, :estado)");
    ...
    static public function CambiarNotaM($tablaBD, $datosC){
        ...
        $pdo = ConexionBD::cBD()->prepare("UPDATE $tablaBD SET fecha = :fecha, profesor = :profesor, estado = :estado, nota_final = :nota_final
        WHERE id = :id");
    ...
    static public function InscribirCursoM($tablaBD, $datosC){

        $pdo = ConexionBD::cBD()->prepare("INSERT INTO $tablaBD (id_alumno, id_curso, id_comision) VALUES (:id_alumno, :id_curso, :id_comision)");
    ...
    static public function BorrarInscM($tablaBD, $id){
